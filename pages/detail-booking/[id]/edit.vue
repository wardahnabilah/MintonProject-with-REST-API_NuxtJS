...
<template>
    <main class="min-h-screen py-32 dark:bg-primary-dark">
        <h1 class="text-2xl text-center dark:text-white font-extrabold uppercase tracking-wider">Edit Booking</h1>
        <form @submit.prevent="editNewBooking" class="w-9/12 max-w-sm mx-auto mt-10 text-lg grid gap-6">
